 ...
 */
final class Version20190403130928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE valide valide VARCHAR(20) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_42C849554CC8505A ON reservation');
        $this->addSql('DROP INDEX UNIQ_42C8495519EB6921 ON reservation');
        $this->addSql('ALTER TABLE reservation CHANGE valide valide VARCHAR(20) DEFAULT \'non\' COLLATE utf8mb4_unicode_ci');
